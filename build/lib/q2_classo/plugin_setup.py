...
plugin.methods.register_function(
    ...
    outputs=[("x", FeatureTable[Frequency])],
    input_descriptions={
        "features": (
...
plugin.methods.register_function(
    ...
    parameters={},
    outputs=[("x", FeatureTable[Frequency]), ("aweights", Weights)],
    input_descriptions={
...
plugin.methods.register_function(
    ...
    inputs={"features": FeatureTable[Frequency], "c": ConstraintMatrix, "weights":Weights},
    parameters={"covariates": Metadata, "to_add": List[Str],"rescale":List[Bool], "w_to_add":List[Float]},
    outputs=[
        ("new_features", FeatureTable[Frequency]),
...
plugin.methods.register_function(
    ...
    inputs={"features": FeatureTable[Frequency], "problem": CLASSOProblem},
    parameters={},
